 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.ecommerceapp.staging
 */

const BUNDLE_ID = 'com.ecommerceapp'; // ios bundle id
const PACKAGE = 'com.ecommerceapp'; // android package name
const NAME = 'ecommerceApp'; // app name
